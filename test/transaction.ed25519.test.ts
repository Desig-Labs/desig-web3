import { Signer, Transaction, toSolanaAddress, TransactionType } from '../dist'
import {
  alicePrivkey,
  bobPrivkey,
  carolPrivkey,
...
import { EdCurve, SecretSharing } from '@desig/core'
import { Curve } from '@desig/supported-chains'

describe('ed25519: transaction', () => {
  ...
  it('sync n-extension: alice, bob, eddy', async () => {
    ...
    const pubkey = EdCurve.getPublicKey(derkey, true)
